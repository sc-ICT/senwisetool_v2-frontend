...
interface QuestionGroupCreateDialogProps {
  isPending: boolean;
  onClose: () => void;
  onSubmit: (data: { name: string; description: string | null }) => void;
}

export function QuestionGroupCreateDialog({
  isPending,
  onClose,
  onSubmit,
}: QuestionGroupCreateDialogProps) {
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="question-group-create-title"
        style={{
          width: "100%",
          maxWidth: "460px",
          borderRadius: "1rem",
      ...
      >
        ...
        >
          <div>
            <div
              id="question-group-create-title"
              style={{
                display: "flex",
                alignItems: "center",
                gap: "0.5rem",
